...
export default class App extends Component {
  ...
  spInputs(){
    ...
    return(
      <select onChange={this.AddTicker} size={10} style={{width:500, height: 75, fontSize:15, backgroundColor: 'cyan', color: 'black'}}>
        {hold}
      </select>
    )
  }
  ...
  DisplayTicks(){
    ...
    return(
      <tr style={{backgroundColor: 'black', color: 'cyan'}}>
        {hold}
      </tr>
    )
  }
  ...
  DisplayParams(){
    ...
    wealth.push(<td><input name="epochs" value={this.state.epochs} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    wealth.push(<td><input name="window" value={this.state.window} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    wealth.push(<td><input name="output" value={this.state.output} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    wealth.push(<td><input name="lr" value={this.state.lr} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    wealth.push(<td><input name="prop" value={this.state.prop} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    wealth.push(<td><input name="ma_vol" value={this.state.ma_vol} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    wealth.push(<td><input name="skip" value={this.state.skip} style={{backgroundColor: 'black', color: 'cyan', width: 70, textAlign: 'center'}} onChange={this.adjustInputs}/></td>)
    return(
      <Fragment>
        <tr style={{backgroundColor: 'cyan', color: 'black'}}>
          {gold}
        </tr>
        <tr style={{backgroundColor: 'cyan', color: 'black'}}>
          {hold}
    ...
    return(
      <Fragment>
        <center>
          ...
          <Tabs>
            <TabList style={{backgroundColor:'cyan'}}>
              <Tab>Home</Tab>
              <Tab>Portfolio</Tab>
              <Tab>Prices</Tab>
            </TabList>
            <TabPanel>
              <br/>
              <input name="enter" value={this.state.enter} onChange={this.inputChange} style={{backgroundColor: 'cyan', color: 'black', textAlign: 'center', width: 300}}/>
              <br/>
              <br/>
              ...
              <br/>
              <br/>
              <button type="button" onClick={this.fetchData} style={{width: 120, backgroundColor: 'black', color:'cyan'}}>Fetch Data</button>
              <button type="button" onClick={this.clearData} style={{width: 120, backgroundColor: 'black', color:'cyan'}}>Clear</button>
              <br/>
              <br/>
              <div style={{backgroundColor: 'cyan', color: 'black'}}>{this.state.run_state}</div>
              <br/>
            </TabPanel>
            <TabPanel>
              <div>{this.plotEF()}</div>
